...
While on the topic of mechanical constraints, our flywheels sometimes changed the trajectory of the bullet, even if the turret was aimed directly at the target. This is because the prints for these flywheels may not have been of high quality, or because the flywheels were slightly misaligned. For a future project, buying the flywheel rollers/cage separately, or using a better printing method for these components, may mitigate these issues. 
